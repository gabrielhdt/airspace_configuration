  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{block}{Sélection}
        ...
        \note[item]{expvexp, choix des nœuds prometteurs, \emph{bandit} methods}
        \begin{figure}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{block}{Simulation}
        ...
        \note[item]{heuristique?, calcul du cout du chemin}
        \begin{figure}
          \begin{tikzpicture}[scale=0.6]
            \node [circle, draw] {}
              child {node [circle, draw] {}}
    ...
    \begin{column}{0.5\textwidth}
      \begin{block}{Sauvegarde}
        ...
        \note[item]{Complète les statistiques nécessaires à la sélection}
      \end{block}
      \begin{figure}
        \begin{tikzpicture}[scale=0.6]
          \node [circle, draw, blue] {}
...
\begin{frame}[c]{Construction de la solution}
  \note{Pas d'utilisation de sélection car pas d'exploration}
  \begin{algorithmic}
  ...
  un coup joué}
  \note[item]{NextNode ici \(\mathup{argmax}\{\mu_v | v \text{\,enfants de\,}
  u\}\)}
\end{frame}
